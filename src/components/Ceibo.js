  ...
  return (
    <div className="flex flex-col space-y-10 px-10 md:px-20 lg:px-52 pt-10 space-y-5">
      ...
      <p className="text-white" style={{ fontFamily: "Poppins" }}>
        I got to work for several years in the manteinance and improvement of a
        Sancor Seguros web platform called "Ceibo". It is a huge project that is
        used mainly for insurance policies administration, among a fine number
        of other insurance agency related things. This project is built with
        .NET, Javascript and SQL technologies
      </p>
